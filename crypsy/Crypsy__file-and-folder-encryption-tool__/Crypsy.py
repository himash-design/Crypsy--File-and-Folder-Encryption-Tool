...
class FileVaultGUI:
    ...
    def _create_widgets(self):
        ...
        def on_filetype_enter(e):
            self.file_type_frame.configure(style='TLabelframe')
        ...
        for text, value, _ in file_types:
            ...
            def on_radio_enter(e, btn=radio_btn):
                btn.configure(style='FileType.TRadiobutton')
        ...
        for text, command, row, col in buttons:
            ...
            def on_button_enter(e, button=btn):
                ...
                button.configure(width=27)  # Enlarge slightly on hover
            def on_button_leave(e, button=btn):
                button.configure(style='Custom.TButton')
                button.configure(width=25)  # Return to original size
